            ...
            <div class="row">
              <div class="col-6">
                  ...
                  <ul class="contact-logo pl-0 mb-0">
                    ...
                    <li class="" style="margin-bottom: 110px;"> <i class="fas fa-map-marker "></i><br>@lang('website.ADDRESS')
                    </li>
...
{{--                    <li> <i class="fas fa-tty"></i><br><phone dir="ltr">@lang('website.FAX')</phone></li>--}}
              ...
              <div class="col-6 right">
                <ul class="contact-info  pl-0 mb-0">
                  <li><font>
                    <a href="#" dir="ltr"><br>+88 01974655043</a>
                  </font> </li>
                  <li> <font><a href="#">@lang('website.Ecommerce')<br>@lang('CNS Tower, 1st & 3rd Floor, 43/R/5-A, West Panthapath, 1215 Dhaka, Bangladesh')</a></font></li>
                  <li> <font><a href="mailto:{{$result['commonContent']['setting'][3]->value}}"><br>info@knoprotec.com</a> </font></li>

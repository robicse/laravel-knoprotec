...
@section('content')
    ...
    <section class="checkout-area">
        ...
        <section class="pro-content" style="padding-top: 30px;">
...
{{--                                                                            <input onClick="paymentMethods();" id="{{$payment_methods['payment_method']}}_labelssl" type="radio" name="payment_method" class="form-check-input payment_method" value="ssl">--}}
{{--                                                                            <label class="form-check-label" for="{{$payment_methods['payment_method']}}_labelssl">--}}
{{--                                                                                SSLCOMMERZ--}}
{{--                                                                            </label>--}}

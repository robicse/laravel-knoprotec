...
<section class="pro-content" style="padding-top: 40px;">
{{--  <div class="container">--}}
              ...
              <tbody  @if(session::get('out_of_stock') == 1 and session::get('out_of_stock_product') == $products->products_id)style="	box-shadow: 0 20px 50px rgba(0,0,0,.5); border:2px solid #FF9999;"@endif>
                  ...
                  <tr class="d-flex">
                    <td class="col-12 col-md-2" >
                      <a href="{{ URL::to('/product-detail/'.$products->products_slug)}}" class="cart-thumb float-left">
                        <img style="width: 70px;height: 70px;" class="img-fluid" src="{{asset('').$products->image_path}}" alt="{{$products->products_name}}"/>
                        </a>
                    </td>

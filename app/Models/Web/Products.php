        ...
        if (count($products) > 0) {
            ...
            foreach ($products as $products_data) {
                ...
                if ($default_images) {
                    ...
                    if ($default_images) {
                        ...
                        $default_images = DB::table('image_categories')
                            ...
                            ->first();
                        $products_data->image_path = !empty($default_images->path)? $default_images->path :'';
                    }
                ...
                if ($default_image_thumb) {
                    ...
                    $products_data->default_thumb = !empty($products_data->default_images) ? $products_data->default_images : "";
                }
